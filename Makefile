all: img/hem.png img/saturated-hem.png img/unsaturated-hem.png img/saturated-hem-emphasize.png img/unsaturated-hem-emphasize.png

img/hem.png: hemplot.gp hem.data
	gnuplot -e "emphasize_factor=0" -e 'outfile="$@"' hemplot.gp

img/saturated-hem-emphasize.png: hemplot.gp hem.data
	gnuplot -e "emphasize_factor=1" -e 'outfile="$@"' hemplot.gp

img/unsaturated-hem-emphasize.png: hemplot.gp hem.data
	gnuplot -e "emphasize_factor=2" -e 'outfile="$@"' hemplot.gp

img/saturated-hem.png: hemplot.gp hem.data
	gnuplot -e "only_show=1" -e 'outfile="$@"' hemplot.gp

img/unsaturated-hem.png: hemplot.gp hem.data
	gnuplot -e "only_show=2" -e 'outfile="$@"' hemplot.gp
